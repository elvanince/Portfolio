            ...
            <section className="page-section" id="contact">
                <div className="container">
                    <div className="text-center">
                        ...
                        <h3 className="section-subheading text-muted">Elvan Ince Arslan.</h3>
                    </div>
...
export default withFormik({
    ...
    validationSchema: Yup.object().shape({
        name: Yup.string().min(3, 'Come on bro, your name is longer than three.').required('You must give us your name.'),
